...
<!--<![endif]-->
    <head>
        ...
        <!--
          ...
          =============================================================================
        -->
        <!--<base href="http://xue.medellin.unal.edu.co/">-->
        ...
        <!-- ESTILOS FACULTAD DE MINAS -->
        <link rel="stylesheet" type="text/css" href="/css/template.css" media="all">
        <!-- ESTILOS PLUGINS Y PROPIOS-->
        <link rel="stylesheet" type="text/css" href="/css/datatables.css" media="all">
        <link rel="stylesheet" type="text/css" href="/css/propio.css" media="all">
        ...
        <title>Universidad Nacional de Colombia : Software Boulevard</title>
    </head>
    <body>
        ...
        <header id="unalTop">
            ...
            <div class="firstMenu">
                ...
                <ul class="socialLinks hidden-xs">
                    <li><a href="https://twitter.com/unmedellin" target="_blank" class="twitter" title="Cuenta oficial en Twitter"></a></li>
                    <li><a href="https://www.facebook.com/UNmedellin" target="_blank" class="facebook" title="Página oficial en Facebook"></a></li>
                    <li><a href="https://www.youtube.com/channel/UC9KV1pUV5HznpgvV37ZAP8w" target="_blank" class="youtube" title="Canal de YouTube de la Sede Medellín"></a></li>
                ...
                <div class="navbar-default">
                    <nav id="profiles">
                        <ul class="nav navbar-nav dropdown-menu">
                            ...
                            <li class="item_Estudiantes #>"><a href="http://medellin.unal.edu.co/estudiantes/">Estudiantes</a></li>
                            <li class="item_Egresados #>"><a href="http://medellin.unal.edu.co/egresados/">Egresados</a></li>
                            <li class="item_Docentes #>"><a href="http://medellin.unal.edu.co/docentes/">Docentes</a></li>
                            <li class="item_Administrativos #>"><a href="http://medellin.unal.edu.co/administrativos/">Administrativos</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            <div id="bs-navbar" class="navbar-collapse collapse navigation">
                <div class="site-url">
                    <a href="/">Software Boulevard - @yield('titulo')</a>
                </div>
                <div class="buscador">
                ...
                <div class="mainMenu">
                    ...
                    @if(isset($user))
                    <div class="btn-group">
                        <div class="btn btn-default dropdown-toggle" data-toggle="dropdown">Account<span class="caret"></span></div>
                        <ul class="dropdown-menu dropItem-16">
                            <li><a href="/my-account/">My Account</a><span class="caret-right"></span></li>
                            <li><a href="/auth/logout">Logout</a><span class="caret-right"></span></li>
                        </ul>
                    </div>
                    @endif
                    <div class="btn-group">
        ...
        <footer class="clear">
          ...
          <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-xxs-12 footer-info">
              <p class="col-sm-12 col-md-6 contacto">
                  <b>Contacto página web:</b><br/> Dirección Carrera 80 No 65-223 - Campus Robledo<br/> Medellin, Colombia<br/> (+57 4)  425 50 00
              </p>
              <p class="col-sm-12 col-md-6 derechos">
                  © Copyright 2016<br/> Algunos derechos reservados.<br/>
                  <a title="Comuníquese con el administrador de este sitio web" href="mailto:cmzapataj@unal.edu.co">cmzapataj@unal.edu.co</a><br/>
                  <a href="index.html#">Acerca de este sitio web</a><br/> Actualización:13/10/16
              </p>
          </div>
